...
import me.travis.wurstplus.wurstplustwo.util.font.CFontRenderer;
...
public class Wurstplus {
	...
	public static final String WURSTPLUS_NAME = "Tesla";
	...
	public void WurstplusStarting(FMLInitializationEvent event) {
		...
		fontRenderer = new CFontRenderer(new java.awt.Font("Ariel", java.awt.Font.PLAIN, 18), true, false);
