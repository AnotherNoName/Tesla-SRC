...
public class WurstplusMessageUtil {
	...
	public static ChatFormatting g = ChatFormatting.DARK_AQUA;
	...
	public static String opener = ChatFormatting.GRAY + "[" + g + Wurstplus.WURSTPLUS_NAME + ChatFormatting.GRAY + "] " + r;
