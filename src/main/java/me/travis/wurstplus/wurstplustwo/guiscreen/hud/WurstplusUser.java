...
public class WurstplusUser extends WurstplusPinnable {
	...
	public void render() {
		...
		FontUtils.drawStringWithShadow(true, line, (int)scaled_width / 2 - (int)FontUtils.getStringWidth(true, line) / 2, 20, new WurstplusDraw.TravisColor(nl_r,nl_g,nl_b,nl_a).hex());
